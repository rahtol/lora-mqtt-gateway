...
void MqttSettingsClass::onMqttConnect(bool sessionPresent)
{
    ...
    publish("version", Lora_Mqtt_Gateway::version);
}
...
void MqttSettingsClass::performConnect()
{
    ...
    static_cast<espMqttClient *>(mqttClient)->setServer("192.168.178.92", 1883);
